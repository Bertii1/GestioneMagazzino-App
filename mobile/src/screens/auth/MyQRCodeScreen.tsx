...
export default function MyQRCodeScreen({ navigation }: Props) {
  ...
  const [loginToken, setLoginToken] = useState<string | null>(pendingQrToken ?? null);
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.hint}>
        Scansiona questo codice dalla schermata di login per accedere direttamente.
      </Text>
...
const styles = StyleSheet.create({
  ...
  banner: {
    width: '100%', backgroundColor: '#EFF6FF', borderRadius: 10,
  ...
  qrCard: {
    ...
    minHeight: 276, justifyContent: 'center', alignItems: 'center',
  },
  hint: {
    fontSize: 13, color: '#6B7280', textAlign: 'center',
    lineHeight: 18, marginBottom: 28, paddingHorizontal: 8,
  },
  btnPrimary: {
  ...
  btnSecondary: {
    width: '100%', borderWidth: 1.5, borderColor: '#D1D5DB',

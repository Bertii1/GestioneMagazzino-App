...
> App mobile-first per gestire prodotti in magazzino — mappa interattiva, scansione barcode, riconoscimento AI e aggiornamenti OTA.
...
**Pattern server:** `Routes → Controllers → Models` (MVC classico)
